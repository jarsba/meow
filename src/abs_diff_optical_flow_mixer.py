from src.video_mixer_base import VideoMixerBase
from src.field_detector import mask_field_from_image
from src.optical_flow import absolute_difference_optical_flow
import cv2
...
class AbsoluteDifferenceOpticalFlowMixer(VideoMixerBase):
    ...
    def mix_video_with_field_mask(self, video_capture_left: cv2.VideoCapture,
                                  ...
                                  history_length=24, output_fps: int = 60,
                                  output_height: int = 1080, output_width: int = 1920,
